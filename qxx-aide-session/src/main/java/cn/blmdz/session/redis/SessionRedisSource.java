package cn.blmdz.session.redis;
...
import cn.blmdz.session.exception.SessionException;
import cn.blmdz.session.properties.SessionProperties;
import cn.blmdz.session.serialize.JsonSerialize;
import cn.blmdz.session.serialize.KryoSerialize;
...
public class SessionRedisSource implements SessionDataSource {
	...
	public SessionRedisSource(JedisExecutor jedisExecutor, SessionProperties properties) {
		...
		if("binary".equals(properties.getSerializeType())) {
